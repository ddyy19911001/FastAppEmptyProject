...
public class RecyclerTabLayout extends RecyclerView {
    ...
    public static boolean isThreeTabType;
    public int indicatorWidth;
    public static int currentPosition;
    public void setIsThreeTabType(boolean isThreeTabType){
        this.isThreeTabType=isThreeTabType;
    }
    ...
    public static class DefaultAdapter
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            tabTextView.setTypeface(Typeface.createFromAsset(parent.getContext().getAssets(), "font/Roboto-Black-800.ttf"));
    ...
    public static class TabTextView extends AppCompatTextView {
        ...
        public TabTextView(Context context) {
            super(context);
            setTypeface(Typeface.createFromAsset(context.getAssets(), "font/Roboto-Black-800.ttf"));
        }

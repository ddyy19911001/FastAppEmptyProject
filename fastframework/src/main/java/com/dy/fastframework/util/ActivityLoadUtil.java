...
public class ActivityLoadUtil {
    ...
    public StatusLayoutManager useDefaultLoadLayout(View view,int emptyLayout ,OnStatusChildClickListener childClickListener){
        StatusLayoutManager manager=  useCustomLayout(view, R.layout.default_loading_layout,emptyLayout,emptyLayout,R.id.re_try_bt,childClickListener);
        return manager;
    }
